...
<body>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3" style="background-color: #07efff !important">
            <nav class="navbar bg-light navbar-light" style="background-color: #07efff !important">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Quyết Phạm</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-white border-1 rounded-0 rounded-bottom m-0">
